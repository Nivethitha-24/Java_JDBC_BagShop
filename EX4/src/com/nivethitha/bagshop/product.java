...
public class product {
	...
	public product(String name, String shop_name, String branch, String jewel_type, int quantity) {
		super();
		this.name = name;
	...
	public String toString() {
		return "Bag [name=" + name + ", shop_name=" + shop_name + ", branch=" + branch + ", jewel_type="
